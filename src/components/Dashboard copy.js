...
// import Lists from "./convertkit/slate-lists/src";
...
class Dashboard extends Component {
    ...
    // lieditor = () => { return useRef(null)}

    // toggleUnorderedList = event => {
    //     event.preventDefault();
    //     this.ref.current.toggleList()
    // }

    // toggleOrderedList = event => {
    //     event.preventDefault();
    //     this.ref.current.toggleList({ type: "ordered-list" })
    // }

    // indent = event => {
    //     event.preventDefault();
    //     this.ref.current.increaseListItemDepth()
    // }

    // outdent = event => {
    //     event.preventDefault()
    //     this.ref.current.decreaseListItemDepth()
    // }
